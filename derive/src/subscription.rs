use crate::{
    ...
    utils::{feature_block, get_crate_name, get_param_getter_ident, get_rustdoc},
};
use inflector::Inflector;
use proc_macro::TokenStream;
use quote::quote;
use syn::{
    ext::IdentExt, Block, Error, FnArg, ImplItem, ItemImpl, Pat, Result, ReturnType, Type,
    TypeImplTrait, TypeReference,
};
